...
import com.google.mediterraneancoin.utils.BtcAutoFormat.Style;
import static com.google.mediterraneancoin.utils.BtcAutoFormat.Style.*;
 ...
 * <code>"฿"</code>.
 *
 * <p>The denomination used when formatting will be either mediterraneancoin, millicoin
 ...
 * locale, a value of one mediterraneancoin might be formatted as <pre>฿1.00</pre> where a value
 ...
 * increasing precision to convert the representation of a given quantity of mediterraneancoins into a
 * representation of the same value denominated in the formatter's units.  For example, a scale
 * value of <code>3</code> specifies a denomination of millimediterraneancoins, because to represent
 * <code>1.0000 BTC</code>, or one mediterraneancoin, in millimediterraneancoins, one shifts the decimal point
 ...
 * values in units of micromediterraneancoins:
 *
 ...
 * differently the same one-mediterraneancoin value:
 *
 * <blockquote><pre>
 ...
 * method.  This argument can be either a {@link com.google.mediterraneancoin.core.Coin}-type object or a
 ...
 * number of mediterraneancoins.  A value having a fractional amount of satoshis is rounded to the
 ...
 * instance will infer a denomination of mediterraneancoins while a {@link BtcFixedFormat} will infer the
 ...
 * @see          com.google.mediterraneancoin.core.Coin
 */
...
public abstract class BtcFormat extends Format {
    ...
    /** The conventional international currency code for mediterraneancoins: "BTC" */
    private static final String COIN_CODE = "BTC";
    /** The default currency symbols for mediterraneancoins */
    ...
    /* Scale is the number of decimal-places difference from same value in mediterraneancoins */
    /** A constant useful for specifying a denomination of mediterraneancoins, the <code>int</code> value
     *  <code>0</code>. */
    public static final int COIN_SCALE = 0;

    /** A constant useful for specifying a denomination of millimediterraneancoins, the <code>int</code>
     *  value <code>3</code>. */
    public static final int MILLICOIN_SCALE = 3;

    /** A constant useful for specifying a denomination of micromediterraneancoins, the <code>int</code>
     *  value <code>6</code>. */
    ...
    public static class Builder {
         ...
         *  denominated in mediterraneancoins.  For example, a denomination of millimediterraneancoins is specified
         ...
         * fixed-denomination of mediterraneancoins, equivalent to invoking this method with an argument
         * of <code>0</code>. */
     ...
     * values in terms of mediterraneancoins, with the given minimum number of fractional
    ...
    /**
     * Formats a mediterraneancoin monetary value and returns an {@link java.text.AttributedCharacterIterator}.
    ...
    /**
     * Formats a mediterraneancoin value as a number and possibly a units indicator and appends the
     ...
     * number of mediterraneancoins, rounded to the nearest satoshi as necessary.
     *
    ...
    /**
     * Formats a mediterraneancoin value as a number and possibly a units indicator to a
     ...
     * <code>BigDecimal</code> is interpreted as that number of mediterraneancoins, rounded to the
     ...
     * mediterraneancoins and that same value as formatted.  A fixed-denomination formatter will ignore
     * the arguments.
     *
    ...
    /**
     * Takes a mediterraneancoin monetary value that the client wants to format and returns the number of
    ...
    /**
     * Takes an object representing a mediterraneancoin quantity of any type the
	...
	BigInteger satoshis;
        // the value might be mediterraneancoins or satoshis
    ...
    /**
      ...
      * {@link com.google.mediterraneancoin.core.Coin} object that represents the parsed value.
      * @see java.text.NumberFormat */
    @Override
     ...
     * String, then the number is interpreted as a quatity of mediterraneancoins.
     * <p>If the pattern contains neither a currency symbol nor sign, then instances of {@link
     * BtcAutoFormat} will interpret the parsed number as a quantity of mediterraneancoins, and instances
    ...
    /** Return the unprefixed currency symbol for mediterraneancoins configured for this object.  The
    ...
    /** Return the unprefixed international currency code for mediterraneancoins configured for this
