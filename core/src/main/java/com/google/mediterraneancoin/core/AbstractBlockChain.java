 ...
 * the lightweight SPV mode, a {@link com.google.mediterraneancoin.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link com.google.mediterraneancoin.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
...
public abstract class AbstractBlockChain {
	...
	for (int i = 0; i < goBack; i++) {        
        ...
        // for (int i = 0; i < params.getInterval(); i++) {
            if (cursor == null) {
