 ...
 * {@link com.google.mediterraneancoin.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link com.google.mediterraneancoin.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link com.google.mediterraneancoin.net.NioClientManager#openConnection(java.net.SocketAddress, com.google.mediterraneancoin.net.StreamParser)}
     * or
     * {@link com.google.mediterraneancoin.net.NioClient#NioClient(java.net.SocketAddress, com.google.mediterraneancoin.net.StreamParser, int)}.</p>
     *
     ...
     * Once the pong is received the value returned by {@link com.google.mediterraneancoin.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.google.mediterraneancoin.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.google.mediterraneancoin.core.Peer#ping()} has never
